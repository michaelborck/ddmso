...
class Config(Config):
    DATA_PATH = PROJECT_DIR + 'data/processed/visible/greyscale/Twilight/'
    ANNOTS_PATH = PROJECT_DIR + 'data/processed/visible/annots/'
    INITIAL_WEIGHTS = PROJECT_DIR + 'weights/mask_rcnn_coco.h5'
    MODEL_WEIGHTS =  PROJECT_DIR + 'weights/mask_rcnn_twilight_cfg_0200.h5'  # Update after training
    MODEL_DIR = PROJECT_DIR + 'experiments/'
    NAME = "twilight_grey_cfg"       # Give the configuration a recognizable name
